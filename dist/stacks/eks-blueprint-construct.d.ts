 ...
 */
export declare class BlueprintConstructBuilder {
 ...
 */
export declare class EksBlueprintConstruct extends Construct {
    private asyncTasks;
    private clusterInfo;
     ...
     */
    waitForAsyncTasks(): Promise<EksBlueprintConstruct>;
    /**
